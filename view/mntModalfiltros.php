<div id="modalcrearFiltros" class="modal fade" data-backdrop="static" data-keyboard="false">
        ...
        <div class="modal-content bd-0">
            ...
            <form method="post" id="Filtro_form">
                <div class="modal-body">
                    <input type="text" name="fil_id" id="fil_id">
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="form-control-label">Titulo: <span class="tx-danger">*</span></label>
                            <input class="form-control" id="fil_titulo" type="text" name="fil_titulo" required/>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="form-control-label">Enlace: <span class="tx-danger">*</span></label>
                            <input class="form-control" id="fil_enlace" type="text" name="fil_enlace" required/>
                        </div>
                    </div>
                </div>
