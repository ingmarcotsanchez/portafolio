<div class="br-logo"><a href="../UsuHome/"><span>[</span>Mis Datos<span>]</span></a></div>
...
<div class="br-sideleft overflow-y-auto">
  ...
  <div class="br-sideleft-menu">
    ...
    <label class="sidebar-label pd-x-15 mg-t-20">Báscias</label>
    ...
    <a href="mntExperiencia.php" class="br-menu-link">
      <div class="br-menu-item">
        <i class="menu-item-icon icon ion-ios-bookmarks-outline tx-24"></i>
        <span class="menu-item-label">Mi Experiencia</span>
      </div>
    </a>
    <label class="sidebar-label pd-x-15 mg-t-20">Trabajos</label>
    <a href="mntFiltro.php" class="br-menu-link">
      <div class="br-menu-item">
        <i class="menu-item-icon icon ion-ios-bookmarks-outline tx-24"></i>
        <span class="menu-item-label">Mis Filtros</span>
      </div>
    </a>

    <a href="mntWorks.php" class="br-menu-link">
      <div class="br-menu-item">
        <i class="menu-item-icon icon ion-ios-bookmarks-outline tx-24"></i>
